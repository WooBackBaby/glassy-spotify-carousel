  ...
  return <div className={`min-h-screen font-sans transition-colors duration-300 ${darkMode ? 'bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900' : 'bg-gradient-to-br from-slate-50 via-white to-slate-100'}`}>
      ...
      <header className="fixed top-4 left-4 right-4 z-50">
        <div className="max-w-7xl mx-auto">
          <div className={`backdrop-blur-xl border shadow-2xl px-8 py-6 rounded-full transition-colors duration-300 ${darkMode ? 'bg-neutral-900/80 border-neutral-700/20' : 'bg-white/80 border-white/20'}`}>
            <div className="flex justify-between items-center">
              ...
              <Button variant="ghost" size="icon" onClick={toggleDarkMode} className={`rounded-full transition-all duration-300 w-12 h-12 backdrop-blur-sm ${darkMode ? 'bg-neutral-700 hover:bg-neutral-600 text-neutral-100' : 'bg-gray-400 hover:bg-gray-300 text-slate-900'}`}>
